...
from .custom import CustomDataset, City4, CityscapesHalf, VOCHalf, Kvasir, Kitty7, Kitty, DIS5K
...
__all__ = [
    ...
    'LoadImageNetSImageFromFile', 'City4', 'Kitty', 'Kitty7', 'VOCHalf', 'CityscapesHalf', "Kvasir", "DIS5K"
]
